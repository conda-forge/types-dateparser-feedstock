About types-dateparser-feedstock
================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/types-dateparser-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/types-dateparser-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add types-dateparser
# for installing globally
pixi global install types-dateparser
```
...
It is possible to list all of the versions of `types-dateparser` available on your platform:
...
```
pixi search types-dateparser --channel conda-forge
```
